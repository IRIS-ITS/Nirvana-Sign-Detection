...
int main() {
    ...
    // Automatically create output directory result/turn_right if it doesn't exist
    try {
    ...
    // Determine starting file index (turn_right1.jpg, turn_right2.jpg, ...)
    int imgIndex = 1;
    ...
    std::cout << "==========================================" << std::endl;
    std::cout << "  Capture Dataset: TURN RIGHT             " << std::endl;
    std::cout << "==========================================" << std::endl;
    ...
    while (true) {
        ...
        cv::imshow("Dataset Capture - TURN RIGHT", displayFrame);
        ...
        if (key == 's' || key == 'S') {
            ...
            if (isAutoRecording) {
                savedCountSession = 0;
                std::cout << "[AUTO REC] Started recording TURN RIGHT frames..." << std::endl;
            } else {
            ...
            std::cout << "Exiting TURN RIGHT capture program..." << std::endl;
            break;
        }
    }
